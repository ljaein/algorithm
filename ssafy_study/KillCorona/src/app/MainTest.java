...
public class MainTest {
	public static void main(String[] args) throws NotCoronaException {
		...
		// Patient p4 = new Patient("환자3", 33, "010-3333-3333", "고열", "001",
		// true);
		try {
		...
		String fileName = "CoronaPatientList.csv";									// AutoCloseable
		try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath + File.separator + fileName));) {
			// 한글 깨진다면 BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(filePath + File.separator + fileName), "MS949"));
